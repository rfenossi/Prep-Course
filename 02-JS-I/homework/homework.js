...
function obtenerResto(x, y) {
  ...
  // Tu código:
  restograciasmodulo = x% y;
  return restograciasmodulo;
}
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
//primer intento no entiendo por que no funciona &nbsp; sera que es solo usado en html?
...
function obtenerSaludo(nombre) {
  ...
  var saludo = "Hola ";
  var finalsaludo = "!";
  var saludocompleto = saludo + nombre + finalsaludo;
